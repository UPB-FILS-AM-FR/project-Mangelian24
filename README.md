...
| Device                                       | Usage                                                    | Quantity | Unit Price (RON) | Total Price (RON) | Link (Example)                                                                                                                            |
| :------------------------------------------- | :------------------------------------------------------- | :------- | :--------------- | :---------------- | :---------------------------------------------------------------------------------------------------------------------------------------- |
...
| Breadboard 170 points (SYB-130)              | Auxiliary breadboard for ESP32 mounting (if used)        | 1        | ~5-8             | ~5-8              | *(Dacă l-ai cumpărat separat, preț estimat)*                                                                                             |
| Jumper Wires (Male-Male, 40pcs, 10cm)        | Connecting components                                    | 1 set    | ~7               | ~7                | [OptimusDigital M-M](https://www.optimusdigital.ro/ro/fire-fire-mufate/884-set-fire-tata-tata-40p-10-cm.html) (Exemplu pentru M-M)         |
| Jumper Wires (Female-Male)                   | Connecting components (ESP32 to breadboard points)       | 1 set    | ~7-10            | ~7-10             | *(Necesare, preț estimat dacă se cumpără separat)*                                                                                       |
| 0.1µF Capacitor                              | DC blocking capacitor for LM386 input                    | 1        | <1               | <1                | (Usually part of a capacitor/resistor kit)                                                                                                |
| DIY Touch Pads                               | Copper tape or other conductive material                 | ~1m      | ~5-10            | ~5-10             | (Local hardware/craft store)                                                                                                                |
| USB Cable (Micro-USB)                        | Programming and power supply for ESP32                   | 1        | (Usually owned)  | 0                 |                                                                                                                                           |
